...
const TaasbabaScreen = () => {
  ...
  const checkKeyword = async text => {
    const keywords = ['didto diri', 'dito diri', 'deto dere', 'did to diri'];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        {showVideo && (
          <Video
            source={require('../../assets/video/intro-diridi.mp4')}
            style={styles.video}
            resizeMode="cover"
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.greetingText1}>Here and There</Text>
