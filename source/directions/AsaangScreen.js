...
const AsaangScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    if (displayText === 'naa sa likod sir') {
  ...
  const handleButtonClick = (text) => {
    if (text === 'naa sa likod sir') {
      setDisplayText('naa sa likod sir');
...
<View style={styles.greetingContainer}>
    ...
    <TouchableOpacity onPress={() => handleButtonClick('naa sa likod sir')}>
      <Text style={styles.buttonText}>naa sa likod sir</Text>
    </TouchableOpacity>
  </Animated.View>
          <TouchableOpacity
              style={styles.button}
              onPress={() => handleButtonClick('asa ang banyo')}>
              <Text style={styles.buttonText}>naa sa kilid sir</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
              onPress={() => handleButtonClick('asa ang banyo')}>
              <Text style={styles.buttonText}>naa didton sir</Text>
            </TouchableOpacity>
           
          </View>
    
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>Maayong adlaw! Asa ang mga prutas dapit? (Greetings! Where are the fruits located?)  
</Text>
<Text style={styles.greetingText10} >Answer: At the back</Text>
          </TouchableOpacity>
