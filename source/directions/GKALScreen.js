      ...
      >
        <View style={styles.centeredView}>
          ...
          <Text style={styles.modalText1}>Congratulations!</Text>
            <Text style={styles.modalText}>You've completed all the Games of Directions</Text>
...
<View style={styles.greetingContainer}>
    ...
    <TouchableOpacity onPress={() => handleButtonClick('Naa sa kilid')}>
      <Text style={styles.buttonText}>Naa sa kilid</Text>
          ...
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>Gusto ko mag duyan , asa ang duyan? (I want to play on the swing, but where’s  the swing?) 
