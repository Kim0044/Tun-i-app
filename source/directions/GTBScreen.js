...
<View style={styles.greetingContainer}>
        ...
        <Text style={styles.greetingText}>Directions</Text>
          ...
          <TouchableOpacity
              ...
              <Text style={styles.buttonText}>sa wala sir</Text>
            </TouchableOpacity>

             <Animated.View style={[styles.button, {transform: [{scale}], backgroundColor: buttonBackgroundColor}]}>
    <TouchableOpacity onPress={() => handleButtonClick('sa tuo sir')}>
      <Text style={styles.buttonText}>sa tuo sir</Text>
    </TouchableOpacity>
  </Animated.View>
            <TouchableOpacity
              style={styles.button}
              onPress={() => handleButtonClick('asa ang banyo')}>
              <Text style={styles.buttonText}>sa kilid sir</Text>
            </TouchableOpacity>
            
          </View>
    
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>Asa ta moliko, wala o tuo? (Where should we turn, right or left?)
</Text>
<Text style={styles.greetingText10} >Answer: right</Text>
          </TouchableOpacity>
