...
const handlePress = async () => {
  try {
    ...
    if (currentScore >= 10) {
      ...
      setScore(newScore);
      setHintText("asa ang (then state what your looking for)");
...
useEffect(() => {
  ...
  const checkKeyword = async (text) => {
    if (text.toLowerCase().includes('asa ang')) { 
...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
       ...
       {showVideo && (
          <Video
            source={require('../../assets/video/intro-asaang.mp4')}
            style={styles.video}
            resizeMode="cover"
  ...
  />
          ...
          <Text style={styles.greetingText1}>Where is</Text>
...
>
  <View style={styles.modalContainer}>
    <View style={styles.modalContent}>
      <Video
        source={require('../../assets/video/CDG.mp4')}
        style={styles.video1}
            resizeMode="cover"
...
export default DidtodiriScreen ;
