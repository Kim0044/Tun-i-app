...
const KilidatbanglikodScreen = () => {
  ...
  const checkKeyword = async text => {
    const keywords = ['nawala ko', 'n awala ko'];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        {showVideo && (
          <Video
            source={require('../../assets/video/intro-nawala.mp4')}
            style={styles.video}
            resizeMode="cover"
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.greetingText1}>I’m Lost</Text>
...
export default KilidatbanglikodScreen;
