...
<View style={styles.greetingContainer}>
    ...
    <TouchableOpacity onPress={() => handleButtonClick('down')}>
      <Text style={styles.buttonText}>down</Text>
          ...
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>Maayong adlaw! Patabang ka ug pababa sa imohang gipamalit? (Greetings! Would you like some help taking your groceries [sa baba]) 
</Text>
<Text style={styles.greetingText10} >question:  what is “ baba” in English?</Text>
          </TouchableOpacity>
