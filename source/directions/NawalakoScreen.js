...
const handlePress = async () => {
  try {
    ...
    if (currentScore >= 10) {
      ...
      setScore(newScore);
      setHintText("kilid - atbang - likod");
  ...
  const checkKeyword = async (text) => {
    const keywords = ['kilid atbang likod', 'kilid at bang likod', 'keled at bang lekod', 'gilid at bang likod', 'kilit at bang likod'];
...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        {showVideo && (
          <Video
            source={require('../../assets/video/intro-kilid.mp4')}
            style={styles.video}
            resizeMode="cover"
  ...
  />
          ...
          <Text style={styles.greetingText1}>Side, Front and Back</Text>
...
>
  ...
  <Video
        source={require('../../assets/audio/Amazing!(Girl).mp3')} // Adjust the path as necessary
