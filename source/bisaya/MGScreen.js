...
const handlePress = async () => {
  ...
  const checkKeyword = async (text) => {
    const keywords = ['maayong gabi', 'paayong gabii', 'aayong gabi', 'maayong gabi', 'maayong gabiin', 'maayong gabii'];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
       ...
       {showVideo && (
          <Video
            source={require('../../assets/video/intro-maayongG.mp4')}
            style={styles.video}
            resizeMode="cover"
...
>
  ...
  >
    <View style={styles.centeredView}>
      <View style={styles.modalView}>
        <Text style={styles.greetingText2}>{modalMessage}</Text>
        <TouchableHighlight
