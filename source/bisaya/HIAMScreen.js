...
const HIAMScreen = () => {
  ...
  const handlePress = async () => {
    try {
      ...
      if (currentScore >= 10) {
        ...
        setScore(newScore);
        setHintText('Hi ako diay si (state your name)');
  ...
  const checkKeyword = async text => {
    const keywords = ['hi ako di si', 'hi ako di ay si'];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        {showVideo && (
          <Video
            source={require('../../assets/video/intro-MG.mp4')}
            style={styles.video}
            resizeMode="cover"
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.greetingText1}>Hi I am</Text>
          ...
          <View style={styles.recordButtonContainer}>
            ...
            <Vide
              source={require('../../assets/audio/GoodJob!(Girl).mp3')}
              paused={!audioPlaying}
              audioOnly={true}
