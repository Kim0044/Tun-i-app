...
const PMAScreen = ({ navigation }) => {
  ...
  const handleButtonClick = (text) => {
    if (text === 'Maayong buntag') {
      setDisplayText('Maayong buntag');
  ...
  />
    ...
    <TouchableOpacity onPress={() => handleButtonClick('Maayong buntag')}>
