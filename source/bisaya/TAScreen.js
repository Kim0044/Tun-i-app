...
useEffect(() => {
  ...
  const checkKeyword = async (text) => {
    if (text.toLowerCase().includes('taga-asa ka')) { 
...
useEffect(() => {
  if (failedAttempts >= 3) {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('Section'); // Navigate to "HIA"
    }, 7000);
  }
}, [failedAttempts]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
       ...
       {showVideo && (
          <Video
            source={require('../../assets/video/intro-tagaa.mp4')}
            style={styles.video}
            resizeMode="cover"
...
>
  <View style={styles.modalContainer}>
    <View style={styles.modalContent}>
      <Video
        source={require('../../assets/video/CBG.mp4')}
        style={styles.video1}
            resizeMode="cover"
