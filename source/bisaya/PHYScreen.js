  ...
  />
     <View style={styles.greetingContainer}>
        ...
        <Text style={styles.greetingText}>Greetings</Text>
          ...
          <Text style={styles.greetingText1}>How are you?</Text>
          ...
          <TouchableOpacity
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={() => handleButtonClick('Taga asa mo?')}>
    ...
    <TouchableOpacity onPress={() => handleButtonClick('Kumusta ka?')}>
      <Text style={styles.buttonText}>Kumusta ka?</Text>
    </TouchableOpacity>
