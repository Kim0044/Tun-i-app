...
const handlePress = async () => {
  ...
  const checkKeyword = async (text) => {
    if (text.toLowerCase().includes('pasaylo ako')) { 
...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
       ...
       {showVideo && (
          <Video
            source={require('../../assets/video/intro-pasal.mp4')}
            style={styles.video}
            resizeMode="cover"
  ...
  />
          ...
          <Text style={styles.greetingText1}>I’m sorry</Text>
...
>
  ...
  <Video
        source={require('../../assets/audio/Goodjob.mp3')} // Adjust the path as necessary
