        ...
        <View style={styles.card}>
          ...
          <View style={styles.buttonContainer1}>
            ...
            <Animated.View
              ...
              <TouchableOpacity
                onPress={() => handleButtonClick('Nalipay ko na nakaila tika')}>
                <Text style={styles.buttonText}>
                  Nalipay ko na nakaila tika
                </Text>
              </TouchableOpacity>
            </Animated.View>
            <TouchableOpacity
          ...
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>
              Maayong Buntag! Ako diay si Ryan ug I’m pleased to meet you .
              (Good morning! My name is brya and I am pleased to meet you.)
            </Text>
            <Text style={styles.greetingText10}>
              Question: What is “pleased to meet you” in bisaya?
            </Text>
          </TouchableOpacity>
