...
const DRScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    if (displayText === 'Nalipay ko na nakaila tika') {
  ...
  const handleButtonClick = (text) => {
    if (text === 'Nalipay ko na nakaila tika') {
      setDisplayText('Nalipay ko na nakaila tika');
...
<View style={styles.greetingContainer}>
    ...
    <TouchableOpacity onPress={() => handleButtonClick('Nalipay ko na nakaila tika')}>
  ...
  <TouchableOpacity
          ...
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>Maayong Buntag! Ako diay si  Ryan ug I’m pleased to meet you .  (Good morning! My name is brya and I am pleased to meet you.) 
</Text>
<Text style={styles.greetingText10} >Question: What is “pleased to meet you” in bisaya?</Text>
          </TouchableOpacity>
