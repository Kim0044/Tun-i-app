...
const handlePress = async () => {
  ...
  const checkKeyword = async (text) => {
    if (text.toLowerCase().includes('walay sapayan')) { 
...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
       ...
       {showVideo && (
          <Video
            source={require('../../assets/video/intro-walasapa.mp4')}
            style={styles.video}
            resizeMode="cover"
  ...
  />
          ...
          <Text style={styles.greetingText1}>Your welcome</Text>
