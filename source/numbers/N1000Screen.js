...
const N1000Screen = ({ navigation }) => {
  ...
  const handleButtonClick = (text) => {
    if (text === 'Walay sapayan') {
      setDisplayText('Walay sapayan');
...
<View style={styles.greetingContainer}>
    ...
    <TouchableOpacity onPress={() => handleButtonClick('Walay sapayan')}>
      <Text style={styles.buttonText}>Walay sapayan</Text>
          ...
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>Salamat sa regalo! (Thank you for the gift!) 
</Text>
<Text style={styles.greetingText10} >[Say your welcome in bisaya]</Text>
          </TouchableOpacity>
