        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.modalText}>
              You've completed all the Games of Expression
            </Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.buttonContainer1}>
            <Animated.View
              ...
              <TouchableOpacity
                onPress={() => handleButtonClick('Gimingaw ko nimo')}>
          ...
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>I missed you!</Text>
            <Text style={styles.greetingText10}>
              Question: What is “I missed you” in bisaya?
            </Text>
          </TouchableOpacity>
