...
const DWRSScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    if (displayText === 'Gimingaw ko nimo') {
  ...
  const handleButtonClick = (text) => {
    if (text === 'Gimingaw ko nimo') {
      setDisplayText('Gimingaw ko nimo');
      ...
      >
        <View style={styles.centeredView}>
          ...
          <Text style={styles.modalText1}>Congratulations!</Text>
            <Text style={styles.modalText}>You've completed all the Games of Expression</Text>
...
<View style={styles.greetingContainer}>
    ...
    <TouchableOpacity onPress={() => handleButtonClick('Gimingaw ko nimo')}>
      <Text style={styles.buttonText}>Gimingaw ko nimo</Text>
    </TouchableOpacity>
  </Animated.View>
          <TouchableOpacity
              style={styles.button}
              onPress={() => handleButtonClick('asa ang banyo')}>
              <Text style={styles.buttonText}>Nalipay ko na nakaila tika</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
              onPress={() => handleButtonClick('asa ang banyo')}>
              <Text style={styles.buttonText}>Gusto taka</Text>
            </TouchableOpacity>
         
          </View>
    
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>I missed you!
</Text>
<Text style={styles.greetingText10} >Question: What is “I missed you” in bisaya?</Text>
          </TouchableOpacity>
