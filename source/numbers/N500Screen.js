...
useEffect(() => {
  ...
  const checkKeyword = async (text) => {
    const keywords = ['gimingaw kunimo', 'gimingaw konimo','gimingaw ko nimo','gimingaw'];
...
useEffect(() => {
  if (failedAttempts >= 3) {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('Numbers'); // Navigate to "HIA"
    }, 7000);
  }
}, [failedAttempts]);
...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
       ...
       {showVideo && (
          <Video
            source={require('../../assets/video/intro-gemi.mp4')}
            style={styles.video}
            resizeMode="cover"
  ...
  />
          ...
          <Text style={styles.greetingText1}>I missed you</Text>
...
>
  <View style={styles.modalContainer}>
    <View style={styles.modalContent}>
      <Video
        source={require('../../assets/video/CEG.mp4')}
        style={styles.video1}
            resizeMode="cover"
