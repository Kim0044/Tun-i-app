...
<View style={styles.greetingContainer}>
    ...
    <TouchableOpacity onPress={() => handleButtonClick('Pasayloa ko')}>
      <Text style={styles.buttonText}>Pasayloa ko</Text>
          ...
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>Uy gang, kalimot kag bayad.  (Hey student, you forgot to pay) 
</Text>
<Text style={styles.greetingText10} >[Ask for forgiveness]</Text>
          </TouchableOpacity>
