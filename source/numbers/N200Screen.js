...
const handlePress = async () => {
  ...
  const checkKeyword = async (text) => {
    const keywords = ['nalipay ko nga nakaila tika', 'nalipay ko na kay latika', 'nalipay ko nga nakailatika', 'nalipay ko nga kaila tika', 'nalipay ko na nakaelatika','nalipay ko na nakailatika','nalipay ko'];
