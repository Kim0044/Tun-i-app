...
const handlePress = async () => {
  ...
  const checkKeyword = async (text) => {
    const keywords = ['nalain', 'nala in', 'nala en', 'lalain',];
...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
       ...
       {showVideo && (
          <Video
            source={require('../../assets/video/intro-lain.mp4')}
            style={styles.video}
            resizeMode="cover"
  ...
  />
          ...
          <Text style={styles.greetingText1}>Upset</Text>
