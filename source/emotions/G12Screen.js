...
<Text style={styles.greetingLabel}>Basic:</Text>
        <Text style={styles.greetingText}>Emotions</Text>
          ...
          <TouchableOpacity
              ...
              <Text style={styles.buttonText}>Naglibog ko</Text>
            </TouchableOpacity>

             <Animated.View style={[styles.button, {transform: [{scale}], backgroundColor: buttonBackgroundColor}]}>
    <TouchableOpacity onPress={() => handleButtonClick('Nahadlok ko')}>
      <Text style={styles.buttonText}>Nahadlok ko</Text>
    </TouchableOpacity>
  </Animated.View>
            <TouchableOpacity
              style={styles.button}
              onPress={() => handleButtonClick('asa ang banyo')}>
              <Text style={styles.buttonText}>Nalipay ko</Text>
            </TouchableOpacity>
            
          </View>
    
          <TouchableOpacity style={styles.buttonContainer}>
            <Text style={styles.greetingText9}>I’m Scared!
</Text>
<Text style={styles.greetingText10} >Question: What is “I’m scared” in bisaya?</Text>
          </TouchableOpacity>
