...
const handlePress = async () => {
  ...
  const checkKeyword = async (text) => {
    const keywords = ['nagmugot', 'nagmugpot', 'nag-mogot', 'nag-mugpot',];
...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
       ...
       {showVideo && (
          <Video
            source={require('../../assets/video/intro-mog.mp4')}
            style={styles.video}
            resizeMode="cover"
  ...
  />
          ...
          <Text style={styles.greetingText1}>Displeasure</Text>
