...
const handlePress = async () => {
  ...
  const checkKeyword = async (text) => {
    const keywords = ['naglibog', 'naglebog', 'Naglibug',];
...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
       ...
       {showVideo && (
          <Video
            source={require('../../assets/video/intro-libog.mp4')}
            style={styles.video}
            resizeMode="cover"
  ...
  />
          ...
          <Text style={styles.greetingText1}>Confused</Text>
