...
const G16Screen = ({ navigation }) => {
  const [displayText, setDisplayText] = useState('');
  const [showTryAgain, setShowTryAgain] = useState(false);
  const [showCorrect, setShowCorrect] = useState(false);
  const [level, setLevel] = useState(44);
  ...
  useEffect(() => {
    if (failedAttempts >= 2) {
      ...
      setTimeout(() => {
        ...
        navigation.navigate('NAL'); // Navigate to "PHY" screen
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.modalText}>You've completed all the Games of Basic Emotion!</Text>
...
<Text style={styles.greetingLabel}>Basic:</Text>
    ...
    <TouchableOpacity onPress={() => handleButtonClick('Naglibog')}>
      <Text style={styles.buttonText}>Naglibog</Text>
    </TouchableOpacity>
  </Animated.View>
            <TouchableOpacity
              style={styles.button}
              onPress={() => handleButtonClick('asa ang banyo')}>
              <Text style={styles.buttonText}>Nagmug-ot</Text>
            </TouchableOpacity>
             
          <TouchableOpacity
              style={styles.button}
              onPress={() => handleButtonClick('asa ang banyo')}>
              <Text style={styles.buttonText}>Nalipay</Text>
            </TouchableOpacity>
...
Question: What emotion is the character showing?
</Text>
